package  
{
	...
	public class EndGame extends FlxState
	{
		...
		{
			title = new FlxText(250, 20, 300, "THE END");
			title.size = 32;
			add(title);		
		...
		public function addSummary(stat:String, dyn:String):void {
			...
			var staticText:FlxText = new FlxText(25, 30 * (lineNumber + 3), 200, stat);
			staticText.setFormat(null, 13, 0xffffff, "right")

			var dynamicText:FlxText = new FlxText(250, 30 * (lineNumber + 3), 250, dyn);
			dynamicText.setFormat(null, 13, 0x000000, "center")
			
			var sprite:FlxSprite = new FlxSprite(250, 30*(lineNumber + 3));

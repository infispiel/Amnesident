package
{
    ...
    public class Tokens {
		...
		public static var cloneTvNews:Item = new Item(AssetsRegistry.tvPic, 134, 375, "The reporter is saying: 'President Craine has just authorized the distribution of free fedoras to all children under the age of 6. Truly, a great day for America!'");
		...
		public static var vpTvNews:Item = new Item(AssetsRegistry.tvPic, 134, 375, "Huh. They're reporting about the UN as if it rules the world. And as if it's a dictatorship. And the Vice President is in a throne at the head of the meeting.");
		...
		public static var grayboxRulesTvNews:Item = new Item(AssetsRegistry.tvPic, 134, 375, "It's playing a commercial for Graybox Turkey Substitute with Gray-vy. I'd take moldy yogurt over this any day.");
		...
		public static var tenMinNews:Item = new Item(AssetsRegistry.tvPic, 134, 375, "They're showing fireworks on the 10 o'clock news. It's so pretty!");
		...
		public static var amnesiaSelfTvNews:Item = new Item(AssetsRegistry.tvPic, 134, 375, "The world is half lava, half cat hair? Hiding in boxes is our only hope of survival? Who could have been so irresponsible?");
		...
		public static var amnesiaGrayboxTvNews:Item = new Item(AssetsRegistry.tvPic, 134, 375, "It's a commercial. 'Feeling like the world's not going your way? Graybox Forget-O-Matic! Restart your life today!'");
